...
public class Seal extends AmphibiousAnimal {
    ...
    /**
     * On snow, ice or whatever other animals will spawn on, in daylight, and by the water. Shared with
     * the walrus: in 1.2.5 both wanted snow underfoot and nothing else, which put them far inland.
     */
