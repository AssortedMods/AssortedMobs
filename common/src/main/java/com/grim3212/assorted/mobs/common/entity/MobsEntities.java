...
public class MobsEntities {
    ...
    public static final IRegistryObject<EntityType<TreasureMob>> TREASURE_MOB = register("treasure_mob", EntityType.Builder.of(TreasureMob::new, MobCategory.CREATURE).noLootTable().sized(0.85F, 0.8F).clientTrackingRange(10));
